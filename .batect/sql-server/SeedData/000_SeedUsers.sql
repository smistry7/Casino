...
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('fa20cd73-d1b0-49d9-83ae-00bc661a607d', 'omcgragh0', 17.08, 0.56, '10/4/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('cb650762-88ec-473f-90e6-fed3e5c63b1c', 'ntremellan1', 202.61, 0.7, '4/13/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('c7a85a6a-b044-45fe-8c8c-61db11826d31', 'jcharge2', 717.37, 0.65, '12/16/2021');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('397603c1-ca26-40b9-9159-726a0fa14400', 'rgroombridge3', 415.83, 0.95, '4/10/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('1559a653-82a6-4e1b-a6e1-5890f6a04b88', 'sfinn4', 554.82, 0.45, '5/17/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('c19f5b90-a733-4055-b114-33ba12262293', 'mdinse5', 196.97, 0.82, '8/19/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('cbe4665e-a2ee-46e6-ae90-48e339cc9500', 'bbexley6', 456.76, 0.92, '11/19/2021');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('05d3463c-1fd1-4ec0-a9fd-0b804583fd1e', 'edrejer7', 869.08, 0.66, '11/10/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('d60a1c46-679e-48b2-b39b-b9deb45703ac', 'smatuska8', 794.72, 0.41, '8/9/2022');
insert into dbo.UserAccount (id, Username, balance, LuckCoefficient, DateJoined) values ('8dc07f18-4dd6-4629-b393-2d319652819c', 'pdurno9', 888.10, 0.83, '4/13/2022');
